...
import ShowPics from "@/pages/haoke/Utils/ShowPics";
import EditResource from "@/pages/haoke/HousingManagement/EditResource";
...
// mapStateToProps,第一个是model层属性，第二个是model层方法
@connect(({ houseResource, loading }) => ({// 将model层state绑定到props中
  houseResource,
  loading: loading.models.houseResource,
}))
@Form.create()
class HousingList extends PureComponent {
  state = {
    // modalVisible: false,
